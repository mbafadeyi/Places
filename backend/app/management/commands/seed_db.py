...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user1 = User.objects.create_user(
            username="user1", password="password001", is_host=True
        )
        user2 = User.objects.create_user(
            username="user2", password="password002", is_host=True
        )
        user3 = User.objects.create_user(
            username="user3", password="password003", is_host=True
        )
        ...
        review2 = Review.objects.create(
            reviewer=user3,
            property=property1,
            review_text="Amazing stay! The villa is beautiful and the host was very accomodating.",
            rating=5,
        )
