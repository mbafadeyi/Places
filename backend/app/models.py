...
# This modle is ued to storer different types of properties
class PropertyType(models.Model):
    name = models.CharField(max_length=100)


# This model is used to store detailed information about rooms within properties
...
# This model is used to store reviews made by user for properties
...
# This model is ued to store information about photos related to properties
